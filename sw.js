...
'use strict';
const CACHE = 'miette-shell-v4.0.13';
const ASSETS = [
  ...
  'js/diet.js?v=2', 'js/cooking.js?v=1', 'js/runtime.js?v=6', 'js/notebook.js?v=6', 'js/cloud.js?v=8', 'js/scanner.js', 'js/icons.js?v=6', 'js/evidence.js?v=4', 'js/data.js?v=6', 'js/rules.js?v=4', 'js/api.js?v=9', 'js/plus.js?v=5', 'js/workshop.js?v=7', 'js/recipe-access.js?v=3', 'js/seo-routes.js?v=1', 'js/app.js?v=32', 'js/tonight-rules.js?v=2', 'js/tonight-view.js?v=3', 'js/tonight.js?v=3', 'assets/tonight.css?v=1', 'assets/seo.css?v=2', 'js/onboarding.js?v=1', 'assets/onboarding.css?v=1',
