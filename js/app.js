(() => {
  ...
  function footer() {
    return `<footer class="footer"><span><span class="footer-brand">poum</span> · Alimentation & grossesse</span><div class="footer-links"><a href="#sources">Sources & méthode</a><a href="#confidentialite">Vos données</a><a href="#plus">Plus</a></div></footer>`;
  }
  ...
  function renderRoute(keepDialog = false) {
    ...
    syncSidebar();
    document.title = `${labels[route.page]} — Poum`;
